Version 2.0.4 of the Dynamic Regulatory Events Miner (DREM)
-------------------------------------------------------------------------------
The DREM software was developed by Jason Ernst in collaboration with Ziv Bar-Joseph, William Eric Devanny, Anthony Gitter and Marcel Schulz. 
Any questions about the software or bugs found should be emailed to jernst@cs.cmu.edu or maschulz@cs.cmu.edu.
...
-------------------------------------------------------------------------------
DREM requires Java 1.5 or later to be installed.  Java can be downloaded from
http://www.java.com.
...
-------------------------------------------------------------------------------
DREM is distributed under a GPL v3.0 license.  
...
DREM makes use of the Batik software which is distributed under an Apache license
